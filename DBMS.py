...
image1='library.png'
image2='image2.png'
image3='library_image.jpg'
image4='Welcome to mpstme library.png'
image5='273746.png'
#pip install Pillow
class menu:
    ...
    def __init__(self):
        ...
        l1=Button(self.a,text='BOOK DATA',font='montserrat 22 bold',fg='Black',bg='#ADEFD1',
            width=19,padx=10,borderwidth=0,command=self.book).place(x=100,y=500)


        l2=Button(self.a,text='STUDENT DATA',font='montserrat 22 bold',fg='Black',bg='#ADEFD1',
    ...
    def book(self):
        self.a.destroy()
        self.a=self.canvases(image5)
        l1=Button(self.a,text='Add Books',font='montserrat 22 bold',fg='Black',bg='#ADEFD1',
            width=15,padx=10,command=self.addbook).place(x=20,y=100)

        l2=Button(self.a,text='Search Books',font='montserrat 22 bold',fg='Black',bg='#ADEFD1',
            width=15,padx=10,command=self.search).place(x=20,y=200)

        l4=Button(self.a,text='All Books',font='montserrat 22 bold',fg='Black',bg='#ADEFD1',
            width=15,padx=10,command=self.all).place(x=20,y=300)

        l4=Button(self.a,text='<< Main Menu',font='montserrat 22 bold',fg='Black',bg='#ADEFD1',
            width=15,padx=10,command=self.mainmenu).place(x=20,y=500)
    ...
    def addbook(self):
        ...
        self.f1=Frame(self.a,height=500,width=650,bg='#ADEFD1')
        self.f1.place(x=500,y=100)

        l1=Label(self.f1,text='Book ID : ',font='montserrat 12 bold',fg='Black',bg='#ADEFD1',pady=1).place(x=50,y=50)
        e1=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.aid).place(x=150,y=50)

        l2=Label(self.f1,text='Title : ',font='montserrat 12 bold',fg='Black',bg='#ADEFD1',pady=1).place(x=50,y=100)
        e2=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.aname).place(x=150,y=100)

        l3=Label(self.f1,text='Author : ',font='montserrat 12 bold',fg='Black',bg='#ADEFD1',pady=1).place(x=50,y=150)
        e3=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.aauthor).place(x=150,y=150)

        l4=Label(self.f1,text='Genre : ',font='montserrat 12 bold',fg='Black',bg='#ADEFD1',pady=1).place(x=50,y=200)
        e2=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.agenre).place(x=150,y=200)

        l4=Label(self.f1,text='Copies : ',font='montserrat 12 bold',fg='Black',bg='#ADEFD1',pady=1).place(x=50,y=250)
        e2=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.acopies).place(x=150,y=250)

        l5=Label(self.f1,text='Location : ',font='montserrat 12 bold',fg='Black',bg='#ADEFD1',pady=1).place(x=50,y=300)
        e3=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.aloc).place(x=150,y=300)

        self.f1.grid_propagate(0)

        b1=Button(self.f1,text='Add',font='montserrat 10 bold',fg='White',bg='#273746',
            width=15,bd=3,command=self.adddata).place(x=150,y=400)

        b2=Button(self.f1,text='Back',font='montserrat 10 bold',fg='White',bg='#273746',
    ...
    def search(self):
        ...
        l1=Label(self.f1,text='Book ID/Title/Author/Genre: ',font=('montserrat 10 bold'),bd=2,
         fg='Black',bg='#ADEFD1').place(x=20,y=40)
        e1=Entry(self.f1,width=25,bd=5,bg='white',fg='black',textvariable=self.sid).place(x=260,y=40)

        b1=Button(self.f1,text='Search',fg='white',bg='#273746',font='montserrat 10 bold',width=9,bd=2,
            command=self.serch1).place(x=500,y=37)
        b1=Button(self.f1,text='Back',fg='white', bg='#273746',font='montserrat 10 bold',width=10,bd=2,
        ...
        if k!="":
            ...
            if len(a)!=0:
                ...
                self.cm =ttk.Combobox(self.f1,textvariable=self.variable ,state='readonly',
                    font='montserrat 15 bold',height=50,width=15,)
    ...
    def combo(self,event):
        ...
        #l7=Label(self.f1,text='copies to update: ',font='montserrat 10 bold',bd=1).place(x=250,y=700)
    ...
    def deleteitem(self):
        try:
            ...
            b1=Button(self.f1,text='Update',fg='white', bg='#273746',font='montserrat 10 bold',width=9,bd=3,command=self.delete2).place(x=500,y=97)
    ...
    def copies(self,varr):
        try:
            ...
            if varr==0:
                b5=Button(self.f1,text='Update',fg='white', bg='#273746',font='montserrat 10 bold',
                    width=9,bd=3,command=self.copiesadd).place(x=500,y=97)
            if varr==1:
                b6=Button(self.f1,text='Update',fg='white', bg='#273746',font='montserrat 10 bold',
    ...
    def all(self):
        ...
        b1=Button(self.f1,text='Back',fg='white', bg='#273746',width=10,bd=3,command=self.rm).place(x=250,y=400)
        conn=sqlite3.connect('test.db')
    ...
    def student(self):
        ...
        l1=Button(self.a,text='Issue book',font='montserrat 22 bold',fg='Black',bg='#ADEFD1',
            width=15,padx=10,command=self.issue).place(x=20,y=100)

        l2=Button(self.a,text='Return Book',font='montserrat 22 bold',fg='Black',bg='#ADEFD1',
            width=15,padx=10,command=self.returnn).place(x=20,y=200)

        l3=Button(self.a,text='Student Activity',font='montserrat 22 bold',fg='Black',bg='#ADEFD1',
            width=15,padx=10,command=self.activity).place(x=20,y=300)
    ...
    def issue(self):
        ...
        self.f1=Frame(self.a,height=550,width=500,bg='#ADEFD1')
        self.f1.place(x=500,y=100)

        l1=Label(self.f1,text='Book ID : ',font='montserrat 15 bold',fg='black', bg='#ADEFD1').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='white',textvariable=self.aidd).place(x=180,y=100)

        l2=Label(self.f1,text='Student Id : ',font='montserrat 15 bold',fg='black', bg='#ADEFD1').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='white',textvariable=self.astudentt).place(x=180,y=150)

        b1=Button(self.f1,text='Back',font='montserrat 10 bold',fg='white', bg='#273746',
            width=10,bd=3,command=self.rm).place(x=50,y=250)

        b1=Button(self.f1,text='Issue',font='montserrat 10 bold',fg='white', bg='#273746',
    ...
    def returnn(self):
        ...
        b1=Button(self.f1,text='Return',font='montserrat 10 bold',fg='white', bg='#273746',
            width=10,bd=3,command=self.returnbook).place(x=200,y=250)
    ...
    def activity(self):
        ...
        l1=Label(self.f1,text='Book/Student ID : ',font='montserrat 15 bold',fg='Black',bg='#ADEFD1').place(x=50,y=30)
        e1=Entry(self.f1,width=20,bd=4,bg='white',textvariable=self.aidd).place(x=280,y=35)
        #l2=Label(self.f1,text='Student Id : ',font='montserrat 15 bold',fg='orange',bg='black').place(x=50,y=80)
        ...
        b1=Button(self.f1,text='Search',fg='white', bg='#273746',font='montserrat 10 bold',
            width=10,bd=3,command=self.searchact).place(x=40,y=450)

        b1=Button(self.f1,text='All',fg='white', bg='#273746',font='montserrat 10 bold',
...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('Pratyaksh', 'Akshaj')")
        conn.commit()
...
#==============================LABELS=========================================
lbl_title = Label(canvas, text = "LOGIN", font=('montserrat', 30,'bold'), fg ='Black')
lbl_title.place(x=580,y=100)

lbl_username = Label(canvas, text = "Username:", font=('montserrat', 15,'bold'),bd=4,bg='white', fg='Black')
lbl_username.place(x=500,y=230)

lbl_password = Label(canvas, text = "Password :", font=('montserrat', 15,'bold'),bd=3, bg='white', fg='Black')
lbl_password.place(x=500, y=330)

# lbl_text = Label(canvas)
# lbl_text.place(x=450,y=500)
# lbl_text.grid_propagate(0)
# 3 lines above commented by Pratyaksh : 1/4/2021
...
#==============================BUTTON WIDGETS=================================
btn_login = Button(canvas, text="LOGIN", font=('montserrat 15 bold'),width=25,command=Login, bg='white', fg='Black')
